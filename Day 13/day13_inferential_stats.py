...
# Sampling is useful because it is not always practical to work with
# the complete population.

# Sampling bias happens when the sample does not properly represent
# the population. For example, selecting only a certain type of customer
# may give a misleading result.

# A confidence interval gives a range of values that is likely to contain
# the true population value.

# The null hypothesis means there is no real difference between the groups.
...
# The difference may still be useful for the business depending on
# business goals.
